...
<section class="team-info standard-spacing-margin">
			...
			if( have_rows('team_members') ):
			    while( have_rows('team_members') ) : the_row(); ?>			        
			    	<div class="content-wrap" >
			    		<div id="<?= get_sub_field('anchor'); ?>" style="position:relative;top:-12rem;"></div>
			    		<img src="<?= get_sub_field('portrait'); ?>" alt="">
				        <div class="content">				        	
	...
	<div class="modal agent-contact-modal"  style="display:none;">			
		<div class="modal-content container">
			<div class="close"><i class="fal fa-times"></i></div>
			<?= get_field('contact_modal_shortcode'); ?>
		</div>		
	</div>
